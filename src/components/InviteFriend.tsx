        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-card p-8 rounded-2xl shadow-[var(--shadow-elegant)] border border-border/50 mb-8">
            ...
            <p className="text-muted-foreground text-center leading-relaxed">
              La promozione è valida solo se l'amico invitato <strong className="text-foreground">non è un giocatore</strong> oppure <strong className="text-foreground">non è stato associato ad altri circoli da almeno 3 anni</strong>. La segnalazione dell'invito deve avvenire la prima volta che l'amico visita il circolo.
            </p>
          </div>
